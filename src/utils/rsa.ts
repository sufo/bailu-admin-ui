...
const PUBLIC_KEY = 'MIGJAoGBAK73aprBU+Vu1o8i5EQMGW9ekR7VgqivyrkLLRRjXRv0TGSNJ5lcij/9QUhx8huP8WUg1hyZ+xmYm1pnyoGADSjc9P2gw6piwPS9a/1qrRbafTayMkGWODppRpc0V92gMhmB/Fugbb6q5bnNZsAB9e8rZ5fnIk2l7xwuQw2ZZbhrAgMBAAE='
...
export const rsa = {
   ...
   */
  encryptByPublicKey: function (val: string = '') {
    if (val === '') {
      return '';
    }
   ...
   */
  decryptByPrivateKey: function (val: string = '') {
    if (val === '') {
      return '';
    }
